package com.rsqu.leetcode.lcci.p08_06_hanota;

import java.util.*;

public class Lcci0806Hanota {
    // 题目描述：本目录 README.md。
    ...
    public static void main(String[] args) {
        ...
        // 示例1
        List<Integer> a = java.util.Arrays.asList(2, 1, 0);
        List<Integer> b = java.util.Arrays.asList();
        List<Integer> c = java.util.Arrays.asList();
        solution.solution(a, b, c);

        // 示例2
        List<Integer> a = java.util.Arrays.asList(1, 0);
        List<Integer> b = java.util.Arrays.asList();
        List<Integer> c = java.util.Arrays.asList();
        solution.solution(a, b, c);
