...
public class Lcci1718ShortestSupersequence {
    ...
    public static void main(String[] args) {
        ...
        // 示例1
        int[] big = new int[]{7, 5, 9, 0, 2, 1, 3, 5, 7, 9, 1, 1, 5, 8, 8, 9, 7] small = [1,5,9};
        // TODO：为 small 设置输入
        Object result1 = solution.solution(big, small);
        ...
        // 示例2
        int[] big = new int[]{1, 2, 3] small = [4};
        // TODO：为 small 设置输入
        Object result2 = solution.solution(big, small);
