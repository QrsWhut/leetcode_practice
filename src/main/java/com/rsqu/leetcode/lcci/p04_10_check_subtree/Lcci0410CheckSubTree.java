...
public class Lcci0410CheckSubTree {
    ...
    public static void main(String[] args) {
        ...
        TreeNode t2 = TreeNode.fromArray(new Integer[]{2});
        Object result1 = solution.solution(t1, t2);
        ...
        // 示例2
        TreeNode t1 = TreeNode.fromArray(new Integer[]{1, null, 2, 4});
        TreeNode t2 = TreeNode.fromArray(new Integer[]{3, 2});
        Object result2 = solution.solution(t1, t2);
