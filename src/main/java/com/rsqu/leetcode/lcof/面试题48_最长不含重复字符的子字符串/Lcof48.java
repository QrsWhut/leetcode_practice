package com.rsqu.leetcode.lcof.面试题48_最长不含重复字符的子字符串;
...
public class Lcof48 {
    ...
    public static void main(String[] args) {
        Lcof48 solution = new Lcof48();

        // 示例1
        String s1 = "abcabcbb";
        Object result1 = solution.solution(s1);
        Object expected1 = 3; // 解释: 因为无重复字符的最长子串是 "abc"，所以其长度为 3。
        ...
        Object expected2 = 1; // 解释: 因为无重复字符的最长子串是 "b"，所以其长度为 1。
