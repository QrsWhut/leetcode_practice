...
public class Lcof26 {
    ...
    public static void main(String[] args) {
        ...
        TreeNode b = TreeNode.fromArray(new Integer[]{3, 1});
        Object result1 = solution.solution(a, b);
        ...
        // 示例2
        TreeNode a = TreeNode.fromArray(new Integer[]{3, 4, 5, 1, 2});
        TreeNode b = TreeNode.fromArray(new Integer[]{4, 1});
        Object result2 = solution.solution(a, b);
