...
public class Lcof2_063 {
    ...
    public static void main(String[] args) {
        ...
        // 示例1
        List<String> dictionary = java.util.Arrays.asList("cat", "bat", "rat");
        String sentence = "the cattle was rattled by the battery";
        Object result1 = solution.solution(dictionary, sentence);
        ...
        // 示例2
        List<String> dictionary = java.util.Arrays.asList("a", "b", "c");
        String sentence = "aadsfasf absbs bbab cadsfafs";
        Object result2 = solution.solution(dictionary, sentence);
        ...
        // 示例3
        List<String> dictionary = java.util.Arrays.asList("a", "aa", "aaa", "aaaa");
        String sentence = "a aa a aaaa aaa aaa aaa aaaaaa bbb baba ababa";
        Object result3 = solution.solution(dictionary, sentence);
        ...
        // 示例4
        List<String> dictionary = java.util.Arrays.asList("catt", "cat", "bat", "rat");
        String sentence = "the cattle was rattled by the battery";
        Object result4 = solution.solution(dictionary, sentence);
        ...
        // 示例5
        List<String> dictionary = java.util.Arrays.asList("ac", "ab");
        String sentence = "it is abnormal that this solution is accepted";
        Object result5 = solution.solution(dictionary, sentence);
