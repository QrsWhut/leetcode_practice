package com.rsqu.leetcode.lcof2.剑指_offer_ii_100_三角形中最小路径之和;

import java.util.*;

public class Lcof2_100 {
    // 题目描述：本目录 README.md。
    ...
    public static void main(String[] args) {
        Lcof2_100 solution = new Lcof2_100();

        // 示例1
        List<List<Integer>> triangle = java.util.Arrays.asList(java.util.Arrays.asList(2), java.util.Arrays.asList(3, 4), java.util.Arrays.asList(6, 5, 7), java.util.Arrays.asList(4, 1, 8, 3));
        Object result1 = solution.solution(triangle);
        ...
        // 示例2
        List<List<Integer>> triangle = java.util.Arrays.asList(java.util.Arrays.asList(-10));
        Object result2 = solution.solution(triangle);
        Object expected2 = -10;
