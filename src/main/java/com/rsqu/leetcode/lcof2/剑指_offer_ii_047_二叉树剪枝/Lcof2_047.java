...
public class Lcof2_047 {
    ...
    public static void main(String[] args) {
        ...
        // 示例1
        TreeNode root = TreeNode.fromArray(new Integer[]{1, null, 0, 0, 1});
        ...
        // 示例2
        TreeNode root = TreeNode.fromArray(new Integer[]{1, 0, 1, 0, 0, 0, 1});
        ...
        // 示例3
        TreeNode root = TreeNode.fromArray(new Integer[]{1, 1, 0, 1, 1, 0, 1, 0});
