...
public class Lcof2_115 {
    ...
    public boolean solution(int[] nums, List<List<Integer>> sequences) {
        // TODO：请实现解法
        return false;
    }
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> sequences = java.util.Arrays.asList(java.util.Arrays.asList(1, 2), java.util.Arrays.asList(1, 3));
        Object result1 = solution.solution(nums, sequences);
        ...
        // 示例2
        int[] nums = new int[]{1, 2, 3};
        List<List<Integer>> sequences = java.util.Arrays.asList(java.util.Arrays.asList(1, 2));
        Object result2 = solution.solution(nums, sequences);
        ...
        // 示例3
        int[] nums = new int[]{1, 2, 3};
        List<List<Integer>> sequences = java.util.Arrays.asList(java.util.Arrays.asList(1, 2), java.util.Arrays.asList(1, 3), java.util.Arrays.asList(2, 3));
        Object result3 = solution.solution(nums, sequences);
