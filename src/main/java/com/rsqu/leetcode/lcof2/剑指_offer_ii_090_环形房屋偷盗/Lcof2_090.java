package com.rsqu.leetcode.lcof2.剑指_offer_ii_090_环形房屋偷盗;

import java.util.*;

public class Lcof2_090 {
    // 题目描述：本目录 README.md。
    ...
    public static void main(String[] args) {
        Lcof2_090 solution = new Lcof2_090();

        // 示例1
        int[] nums = new int[]{2, 3, 2};
        Object result1 = solution.solution(nums);
        ...
        Object result2 = solution.solution(nums);
        ...
        // 示例3
        int[] nums = new int[]{0};
        Object result3 = solution.solution(nums);
        Object expected3 = 0;
