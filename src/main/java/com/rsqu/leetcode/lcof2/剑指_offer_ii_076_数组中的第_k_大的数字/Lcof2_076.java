package com.rsqu.leetcode.lcof2.剑指_offer_ii_076_数组中的第_k_大的数字;

import java.util.*;

public class Lcof2_076 {
    // 题目描述：本目录 README.md。
    ...
    public static void main(String[] args) {
        Lcof2_076 solution = new Lcof2_076();

        // 示例1
        // TODO：为 nums 设置输入
        // TODO：为 k 设置输入
        Object result1 = solution.solution(nums, k);
        Object expected1 = 5;
        ...
        // TODO：为 nums 设置输入
        // TODO：为 k 设置输入
        Object result2 = solution.solution(nums, k);
        Object expected2 = 4;
