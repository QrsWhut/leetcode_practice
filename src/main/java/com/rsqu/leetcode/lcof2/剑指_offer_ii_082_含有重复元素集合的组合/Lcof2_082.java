package com.rsqu.leetcode.lcof2.剑指_offer_ii_082_含有重复元素集合的组合;

import java.util.*;

public class Lcof2_082 {
    // 题目描述：本目录 README.md。
    ...
    public static void main(String[] args) {
        Lcof2_082 solution = new Lcof2_082();

        // 示例1
        int[] candidates = new int[]{10, 1, 2, 7, 6, 1, 5};
        int target = 8;
        Object result1 = solution.solution(candidates, target);
        Object expected1 = java.util.Arrays.asList(java.util.Arrays.asList(1, 1, 6), java.util.Arrays.asList(1, 2, 5), java.util.Arrays.asList(1, 7), java.util.Arrays.asList(2, 6));
        ...
        int target = 5;
        Object result2 = solution.solution(candidates, target);
        Object expected2 = java.util.Arrays.asList(java.util.Arrays.asList(1, 2, 2), java.util.Arrays.asList(5));
