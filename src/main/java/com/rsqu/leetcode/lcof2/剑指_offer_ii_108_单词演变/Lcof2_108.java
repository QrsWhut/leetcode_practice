...
public class Lcof2_108 {
    ...
    public static void main(String[] args) {
        ...
        String endWord = "cog";
        List<String> wordList = java.util.Arrays.asList("hot", "dot", "dog", "lot", "log", "cog");
        Object result1 = solution.solution(beginWord, endWord, wordList);
        ...
        String beginWord = "hit";
        String endWord = "cog";
        List<String> wordList = java.util.Arrays.asList("hot", "dot", "dog", "lot", "log");
        Object result2 = solution.solution(beginWord, endWord, wordList);
