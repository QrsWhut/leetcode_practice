...
public class Lcof2_035 {
    ...
    public static void main(String[] args) {
        ...
        // 示例1
        List<String> timePoints = java.util.Arrays.asList("23:59", "00:00");
        Object result1 = solution.solution(timePoints);
        Object expected1 = 1;
        boolean pass1 = isEqual(result1, expected1);
        System.out.println("示例1：" + (pass1 ? "通过" : "失败") + "，输出=" + format(result1) + "，期望=" + format(expected1));

        // 示例2
        List<String> timePoints = java.util.Arrays.asList("00:00", "23:59", "00:00");
        Object result2 = solution.solution(timePoints);
        Object expected2 = 0;
