...
public class Lcof2_078 {
    ...
    public static void main(String[] args) {
        ...
        // 示例1
        ListNode[] lists = new ListNode[]{{1, 4, 5}, {1, 3, 4}, {2, 6}};
        Object result1 = solution.solution(lists);
        ...
        Object result2 = solution.solution(lists);
        ...
        // 示例3
        ListNode[] lists = new ListNode[]{{}};
        Object result3 = solution.solution(lists);
