...
public class Lcof2_074 {
    ...
    public static void main(String[] args) {
        ...
        Object expected1 = java.util.Arrays.asList(java.util.Arrays.asList(1,6),java.util.Arrays.asList(8,10),java.util.Arrays.asList(15,18)); // 解释:区间 [1,3] 和 [2,6] 重叠, 将它们合并为 [1,6].
        ...
        Object expected2 = java.util.Arrays.asList(java.util.Arrays.asList(1,5)); // 解释:区间 [1,4] 和 [4,5] 可被视为重叠区间。
