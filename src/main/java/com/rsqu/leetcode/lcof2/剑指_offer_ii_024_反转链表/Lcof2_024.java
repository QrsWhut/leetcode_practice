package com.rsqu.leetcode.lcof2.剑指_offer_ii_024_反转链表;

import java.util.*;
import com.rsqu.leetcode.util.ListNode;

public class Lcof2_024 {
    // 题目描述：本目录 README.md。
    ...
    public static void main(String[] args) {
        Lcof2_024 solution = new Lcof2_024();

        // 示例1
        ListNode head = ListNode.fromArray(new int[]{1, 2, 3, 4, 5});
        Object result1 = solution.solution(head);
        Object expected1 = ListNode.fromArray(new int[]{5, 4, 3, 2, 1});
        ...
        Object result2 = solution.solution(head);
        Object expected2 = ListNode.fromArray(new int[]{2, 1});
        boolean pass2 = isEqual(result2, expected2);
        System.out.println("示例2：" + (pass2 ? "通过" : "失败") + "，输出=" + format(result2) + "，期望=" + format(expected2));

        // 示例3
        ListNode head = ListNode.fromArray(new int[]{});
        Object result3 = solution.solution(head);
