...
public class Lcof2_081 {
    ...
    public static void main(String[] args) {
        ...
        int target = 1;
        Object result3 = solution.solution(candidates, target);
        ...
        int target = 1;
        Object result4 = solution.solution(candidates, target);
        ...
        int[] candidates = new int[]{1};
        int target = 2;
        Object result5 = solution.solution(candidates, target);
